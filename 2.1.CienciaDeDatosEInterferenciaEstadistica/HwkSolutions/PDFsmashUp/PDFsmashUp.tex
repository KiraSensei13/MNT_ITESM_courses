...
%----------------------------------------------------------------------------------------%
%Append lectures
\includepdf[page=-3]{./0_CASI_Exercises}
\includepdf[page=-]{./1_Chapter1Solutions}
\includepdf[page=-2]{./2_Chapter2sols}
\includepdf[page=-]{./3_Chapter3sols}
\includepdf[page=-]{./4_Chapter4Sols}

...
%----------------------------------------------------------------------------------------%
%Append lectures
\includepdf[page=-,fitpaper,landscape=true]{./Spectrophotometry_pptx}
\includepdf[page=-,fitpaper]{./UVVis_Spectroscopy_Paper_Review}
\includepdf[page=-,fitpaper]{./HPDUVLEDFAOI}

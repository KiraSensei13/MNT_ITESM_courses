...
We will first define a specific function for each RK order:
...
# Parameters
  ...
  func : string        <-   function of two variable
  x0, y0 : numeric     <-   initial values
  x1 : numeric         <-   upper bound
...
Defining the variables according to the input:
```{r}
funct           = "x^2 - 0.05*y"
init_y          = 1
init_x          = -10

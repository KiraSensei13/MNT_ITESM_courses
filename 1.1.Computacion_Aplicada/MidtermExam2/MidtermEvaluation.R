...
library (deSolve)
RKPlot2 <- function(func_1, func_2, x0, y0, x1, n, plot_ymin, plot_ymax) {
  # Plot of the second, third and fourth order RK approximations
  #
  # Parameters
  # ----------
...
# Calling the function for the solution:
RKPlot2(funct_1, funct_2, init_x, init_y, upper_bound, number_of_steps, 1, 5.5)
...
# Calling the function for the solution:
RKPlot2(funct_1, funct_2, init_x, init_y, upper_bound, number_of_steps, -10000, 3000)
...
# Calling the function for the solution:
RKPlot2(funct_1, funct_2, init_x, init_y, upper_bound, number_of_steps, -150, 65)

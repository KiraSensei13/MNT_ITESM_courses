    ...
    if (problemId == "First Section - Problem 1 a)"){
      ...
      if (problemId == "Second Section - Problem a)"){
        ...
        if (problemId == "Second Section - Problem b)"){
          ...
          instructions <- "Taylor series: The algorithm receives an expression or a string with the function to do and the number of terms to get. The output will be an expression containing all the Taylor series about 0. (30 points)
          *TIP: Use the functions: expression, D, parse and paste within a loop to get the desired output."
...
############ Plot for Problem 1 #############################################
    ...
    hist(glm_predicted, main = "Histogram of Chocolate Frequency in Candy", ylab = "Frequency of Trait", xlab = "Presence of Chocolate", labels = TRUE)

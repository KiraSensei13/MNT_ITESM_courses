...
In a general perspective, the responsible consumer knows what material goods are insignificat as an indicator of quality of life and wealth; and defies the exessive accumulation of material goods without any perception of the ecological and social consequences. It is important to understand that the consumer's choices bring out individual short-term consequences along with long-term social outcomes. From Clay's talk, it is imperative that a resonsible consumer buys consciously taking into account the environmental and social consequences of his consumer choices. However, a concious choice that involves the acceptance of moral responsability requires appropiate knowlwdge. In resent years, increasingly more consumers value companies that are into sustainable development. 

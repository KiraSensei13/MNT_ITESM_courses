...
%----------------------------------------------------------------------------------------%
%Append lectures
\includepdf[page=-]{./00_PRESENTATION_LDS_SPRING_2019}
\includepdf[page=-]{./01_INTRODUCTION}
\includepdf[page=-]{./02_COSMIC_YEAR}
\includepdf[page=-]{./03_PLANETARY_SYSTEM}
\includepdf[page=-]{./04_NON_SUSTAINABLE_INDICATIORS}
\includepdf[page=-]{./05_PLANETARY_BOUNDARIES}
\includepdf[page=-]{./06_Biodiversity}
\includepdf[page=-]{./07_HumanImpacts}
\includepdf[page=-]{./08_CLIMATE_CHANGE}
\includepdf[page=-]{./10_ECOSYSTEMS_SERVICES}

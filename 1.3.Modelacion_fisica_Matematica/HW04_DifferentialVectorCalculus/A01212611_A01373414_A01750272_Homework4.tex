...
\includepdf[page=-]{./pdf/ModelacionProblemassemana04}

%----------------------------------------------------------------------------------------%
%Append the HW's answers
\includepdf[page={1,2,3}]{./pdf/1_2_3_7_8} % 1 2 3
\includepdf[page={1,2,3}]{./pdf/4_5_6_9} % 4 5 6
\includepdf[page={4,5}]{./pdf/1_2_3_7_8} % 7 8
\afterpage{\blankpage} % empty after
\includepdf[page={4}]{./pdf/4_5_6_9} % 9
\includepdf[page=-]{./pdf/10} % 10
\includepdf[page=-]{./pdf/11_12_13} % 11 12 13
